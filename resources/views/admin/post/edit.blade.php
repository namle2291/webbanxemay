<x-admin title="Sửa bài viết">
    <form action="{{ route('admin.post.store', $post->id) }}" method="post" enctype="multipart/form-data">
        <div class="row">
            @csrf
            <div class="col-lg-7">
                <x-input name="title" value="{{$post->title}}" label="Tiêu đề" />
                <x-textarea name="description" value="{{$post->description}}" label="Mô tả"></x-textarea>
            ...
            <div class="col-lg-4">
                ...
                <img src="/storage/post/{{$post->image}}" id="imagePost" class="w-100" alt="">
            </div>
