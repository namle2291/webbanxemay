<x-admin title="Cập nhật user">
    <form action="{{ route('admin.user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-6">
                <x-input value="{{ $user->fullname }}" name="fullname" label="Họ tên" />
                <x-input value="{{ $user->email }}" name="email" type="email" label="Email" />
            ...
            <div class="col-lg-6">
                ...
                <img src="/storage/avatar/{{ $user->avatar }}" id="imageUser" width="200" alt="">
            </div>
            <div class="col-lg-12">
